    ...
    <ProtectedRoute>
      ...
      >
        ...
        <div className="text-center">
          <div className="text-8xl  font-formula1 font-bold text-f1-gray-100 mb-4">
            {elapsedTime}s
          </div>
              ...
              {tooEarly ? (
                ...
                <div className="text-center">
                  <p className="text-2xl text-white">
                    {parseFloat(elapsedTime) < 0.1 ? "Parfait !" :
          ...
          <div className="text-center">
            <div className="inline-flex items-center space-x-3 bg-f1-gray-800/80 border border-red-600 rounded-xl px-6 py-3 backdrop-blur-sm">
              ...
              <div className="text-left ">
                <p className="text-lg font-semibold">Meilleur Score {(bestScore.score_ms / 1000).toFixed(3)}s</p>
              </div>
            </div>
          </div>
        </div>
